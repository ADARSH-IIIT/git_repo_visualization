...
const TreeVisualization = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      alertkro.show("Network error or Incompatible repo")
    }
  };
  ...
  const fetchContentData = async (url, filename) => {
    ...
    try {
      ...
      alertkro.show('Error fetching content');
        ...
        img.onload = async () => {
          ...
          canvas.toBlob(async (blob) => {
            try {
              ...
              // alertkro.show("Clipboard write failed");
...
function showInstructions(e) {
  ...
  if(isblibking){
    alertkro.show('press ESCAPE to stop blinking..')
  }
